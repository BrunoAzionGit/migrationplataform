...
/**
 * Fase 4 do roadmap (ver /docs/ARCHITECTURE.md) — ainda não construído.
  ...
  return (
    <PageShell>
      <Card>
        ...
        <h1 style={{ fontSize: "1.3rem", marginTop: 12 }}>Proxy -> Edge Application/Connector/Workload</h1>
        <p style={{ color: "#64748b", fontSize: "0.9rem" }}>
          Fase 4 do roadmap — ainda não implementado. Ver docs/ARCHITECTURE.md e o
